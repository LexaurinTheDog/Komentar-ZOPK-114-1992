# Část první až třetí — Úvodní ustanovení, obecná ochrana přírody a krajiny, zvláště chráněná území (§§ 1–45)

> **Téma kapitoly:** Tato kapitola zahrnuje úvodní ustanovení zákona (§§ 1–3 — účel, předmět ochrany, vymezení pojmů), celou **část druhou** věnovanou **obecné ochraně přírody a krajiny** (§§ 4–13l — územní systém ekologické stability, významné krajinné prvky, dřeviny, jeskyně, paleontologické nálezy, krajinný ráz, přechodně chráněné plochy, používání cizích druhů v akvakultuře, ochrana před invazními nepůvodními druhy) a úvodní hlavy **části třetí** o **zvláštní územní ochraně** (§§ 14–45 — kategorie zvláště chráněných území, národní parky a jejich zóny, chráněné krajinné oblasti, národní přírodní rezervace, přírodní rezervace, národní přírodní památky, přírodní památky, ochranná pásma, plány péče, zásady péče, smluvní ochrana, vyhlašovací procedura). Klíčové instituty: **systém ekologické stability** (§ 4 odst. 1) s členěním na místní, regionální a nadregionální; **významný krajinný prvek** (VKP) ze zákona a registrovaný (§ 3 odst. 1 písm. b, § 4 odst. 2, § 6); **soustava Natura 2000** se svými dvěma složkami — evropsky významné lokality (EVL) a ptačí oblasti (§ 3 odst. 1 písm. q–r); **šest kategorií ZCHÚ** (§ 14); **čtyři národní parky** (České Švýcarsko, Krkonošský, Podyjí, Šumava — §§ 15a–15d); **členění území NP do čtyř zón** ochrany přírody (§ 18); **klidová území NP** (§ 17 — nahradila dřívější rezervní zóny); **plány péče** o NPR, PR, NPP, PP a CHKO (§ 38) a **zásady péče** o NP (§ 38a); **smluvní zvláštní ochrana** (§ 39); **vyhlašovací řízení** (§ 40) s tzv. **stavebním stopem** (§ 40 odst. 5).
...
- *NSS* [2 As 18/2011 - 97](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/623279) — 6. 1. 2012
...
#### Pětice cílů a princip participace

Ustanovení § 1 formuluje účel zákona jako kompromis pěti svébytných cílů, mezi nimiž je nutno nalézat rovnováhu:

1. **Udržení a obnova přírodní rovnováhy v krajině** — koncept přesahující pouze ochranářské paradigma, zaměřený na celkovou funkčnost krajinných ekosystémů.
2. **Ochrana biologické rozmanitosti** („rozmanitostí forem života") — transpozice závazku z Úmluvy o biologické rozmanitosti (Rio de Janeiro 1992), jíž je ČR od roku 1993 smluvní stranou.
3. **Ochrana přírodních hodnot a krás** — estetický rozměr, který zákon přijímá jako rovnocenný čistě biologickým hodnotám (souvisí s ochranou krajinného rázu podle § 12).
4. **Šetrné hospodaření s přírodními zdroji** — princip trvalé udržitelnosti.
5. **Vytvoření soustavy Natura 2000** — explicitní transpoziční cíl, doplněný do § 1 novelou č. 218/2004 Sb. v souvislosti se vstupem ČR do EU. Tento cíl tvoří materiální základ celé části čtvrté zákona.

Princip **participace** je v § 1 zakotven výslovně jmenováním čtyř kategorií spoluúčastníků: krajů, obcí, vlastníků a správců pozemků. Ochrana přírody tedy podle koncepce zákona není výlučnou doménou státu — je úkolem mnohovrstevnatým, na němž se podílí veřejná moc i soukromé subjekty. Tento princip je dále rozvíjen v institutech jako smluvní ochrana (§ 39), dohody s vlastníky (§ 68 odst. 2), finanční náhrady (§ 58) či účast občanských sdružení v řízeních (§ 70).

#### Klauzule zohlednění hospodářských, sociálních a kulturních potřeb
...
- *ÚS* [Pl.ÚS 42/06](https://nalus.usoud.cz/Search/GetText.aspx?sz=Pl-42-06_1) — nález, 22. 9. 2009
  > „Napadená ustanovení z oblasti ochrany veřejné zeleně totiž spadají pod pojem ochrany přírody a krajiny, jak je obecně vymezen v § 2 zákona č. 114/1992 Sb., o ochraně přírody a krajiny, ve znění pozdějších předpisů, a jak je konkretizován v jeho dalších ustanoveních. Z pohledu regulace těchto zásahů se jedná o záležitosti celostátního významu, kterému odpovídá jednotná celostátní úprava pravidel chování na tomto úseku"
- *NSS* [65 A 10/2024 - 170](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/740445) — 19. 2. 2025
...
#### Definice předmětu ochrany (odst. 1) — pět složek

Definice je **funkční a komplexní**: ochranou přírody a krajiny se rozumí péče o pět složkových kategorií:

| Složka | Příklady objektů ochrany |
|---|---|
| **Živá příroda** | Živočichové, rostliny, jejich společenstva |
| **Neživá příroda** | Nerosty, horniny, geologické celky |
| **Paleontologické dědictví** | Fosilie a jiné pozůstatky života v geologické minulosti |
| **Ekologické a krajinné celky** | Ekosystémy, biotopy, krajina |
| **Estetická a rekreační hodnota krajiny** | Vzhled, přístupnost |

Zákon tedy překračuje úzce biologické pojetí: chrání i abiotické (geologické, paleontologické) hodnoty a — zvláště významně — **estetickou a rekreační hodnotu krajiny**. Tato pátá složka odlišuje ZOPK od jiných evropských úprav, které se zpravidla zaměřují jen na živou přírodu. Estetická složka je v zákoně dále provázána s institutem ochrany krajinného rázu (§ 12).

#### Demonstrativní výčet nástrojů (odst. 2)

Třináct nástrojů (písm. a–m) je vyčteno demonstrativně (slovo „zejména"). Vytváří se tak **systém ochrany strukturovaný do tří úrovní**:

1. **Územní ochrana** — písm. a) (ÚSES), e) (zvláště chráněná území), k) (rekreační a turistická ochrana krajiny).
2. **Druhová ochrana** — písm. b) (obecná a zvláštní ochrana druhů), c) (ochrana nerostů a paleontologických nálezů), d) (dřeviny).
...
#### Územní systém ekologické stability (ÚSES) — písm. a)

ÚSES je institut **strukturální ochrany krajiny**, který má zabezpečit, aby v krajině existoval **vzájemně propojený soubor** stabilních nebo přírodě blízkých ekosystémů. ÚSES se skládá ze tří funkčních prvků:

- **Biocentra** — plošné ekosystémové „uzly" s relativně přirozeným stavem.
- **Biokoridory** — liniové prvky propojující biocentra, umožňující migraci organismů.
- **Interakční prvky** — drobné prvky zvyšující ekologickou stabilitu okolí (např. meze, remízky).

Zákon **rozlišuje tři úrovně** ÚSES podle prostorového měřítka:

| Úroveň | Měřítko | Předmět zájmu | Schvalující orgán koncepce |
|---|---|---|---|
| **Místní** (lokální) | Obvykle do 10 km² | Lokální populace, drobné ekosystémy | Obce, pověřené obecní úřady |
| **Regionální** | Stovky km² | Reprezentativní typy biotopů kraje | Kraje, regionální plány ÚSES |
| **Nadregionální** | Tisíce km² | Migrační koridory celostátního/přeshraničního významu | Ministerstvo životního prostředí |

Generel ÚSES je metodicky propojen s **územně plánovací dokumentací**. Vytváření ÚSES je v § 4 odst. 1 výslovně označeno za **veřejný zájem**, na němž se podílejí vlastníci pozemků, obce i stát.

#### Významný krajinný prvek (VKP) — písm. b)

VKP je institut **plošné ochrany ze zákona** — chrání části krajiny, které tvoří kostru přirozené krajiny i mimo zvláště chráněná území. Zákon konstruuje dvě kategorie VKP:

1. **VKP ze zákona** (taxativní výčet) — lesy, rašeliniště, vodní toky, rybníky, jezera, údolní nivy. Tyto prvky jsou chráněny **automaticky bez nutnosti dalšího aktu**; jejich existence sama o sobě zakládá ochranu podle § 4 odst. 2.
2. **VKP registrované** (deklaratorně-konstitutivně rozhodnutím orgánu ochrany přírody podle § 6) — zejména mokřady, stepní trávníky, remízy, meze, trvalé travní plochy, naleziště nerostů a zkamenělin, skalní útvary, území s přírodě blízkou obnovou těžbou narušeného území. Mohou jimi být i porosty v sídelních útvarech včetně historických zahrad a parků.

> **Praktická poznámka:** Hranice „rašeliniště", „údolní niva" či „vodní tok" nejsou v zákoně přesně definovány. V praxi orgány ochrany přírody vycházejí z geomorfologických a botanických kritérií (např. niva = záplavové území v plochém dně údolí s aluviálními půdami a fluvizemními sedimenty). Spory o vymezení VKP ze zákona řeší v individuálním případě orgán ochrany přírody **deklaratorním aktem** — typicky závazným stanoviskem či sdělením v rámci posuzování konkrétního záměru.

Význam VKP spočívá v tom, že **k zásahům, které by mohly vést k jeho poškození nebo zničení nebo k ohrožení jeho ekologicko-stabilizační funkce, je nezbytný souhlas orgánu ochrany přírody** (§ 4 odst. 2). Tento souhlas má povahu závazného stanoviska v podkladovém řízení (např. ke stavebnímu povolení).

#### Pojmy související s Naturou 2000 — písm. o), p), q), r)

ZOPK transponuje terminologii dvou klíčových směrnic:

| Pojem ZOPK | Pojem směrnice | Směrnice |
|---|---|---|
| Evropská stanoviště | Přírodní stanoviště v zájmu Společenství | Habitatová směrnice 92/43/EHS, příloha I |
| Evropsky významné druhy | Druhy v zájmu Společenství | Habitatová směrnice 92/43/EHS, přílohy II a IV |
| Prioritní stanoviště / druhy | Prioritní stanoviště / druhy | Habitatová směrnice 92/43/EHS |
| Evropsky významná lokalita (EVL) | Site of Community Importance (SCI) → Special Area of Conservation (SAC) | Habitatová směrnice 92/43/EHS, čl. 4 |
| Ptačí oblast | Special Protection Area (SPA) | Ptačí směrnice 2009/147/ES (kodifikace 79/409/EHS), čl. 4 |
| Natura 2000 | Natura 2000 | Habitatová směrnice 92/43/EHS, čl. 3 |

**Vývoj statusu EVL** v § 3 odst. 1 písm. q) probíhá ve třech fázích, které zákon vyjmenovává v bodech 1–3:

1. **Bod 1 — lokalita na národním seznamu**: ČR navrhne lokalitu Evropské komisi (Ministerstvo životního prostředí vyhláškou) na základě biogeografických kritérií.
2. **Bod 2 — tzv. „sporná lokalita"**: lokalita splňuje kritéria, ale na národním seznamu chybí, přitom obsahuje prioritní stanoviště/druh; s Komisí se vede dialog (čl. 5 habitatové směrnice). I taková lokalita požívá ochrany podle ZOPK.
3. **Bod 3 — lokalita na evropském seznamu**: Komise rozhodnutím schválí výběr lokalit. Po zařazení musí být do 6 let (čl. 4 odst. 4 habitatové směrnice) vyhlášena jako zvláštní oblast ochrany (SAC).

**Soustavu Natura 2000** zákon definuje v písm. r) jako **celistvou evropskou soustavu**. „Celistvost" znamená nejen geografickou souvislost, ale především **ekologickou funkčnost** sítě — viz definice celistvosti v písm. u) jako „soudržnost ekologických struktur a funkcí (...) posuzovaná ve vztahu k předmětům jejich ochrany". Tento pojem je klíčový pro posuzování vlivu záměrů podle § 45h–§ 45i.

#### Pojem „příznivý stav" — písm. s), t)

ZOPK přejímá z čl. 1 písm. e) a i) habitatové směrnice koncept **příznivého stavu z hlediska ochrany** (favourable conservation status, FCS). Stav je příznivý, pokud:

- **U stanoviště:** přirozený areál je stabilní/zvětšuje se, struktura a funkce existují a budou existovat, stav typických druhů je příznivý.
- **U druhu:** populační dynamika ukazuje dlouhodobou životaschopnost, areál není a nebude omezen, existují dostatečně velká stanoviště.
...
### Hlava první — Obecná územní a druhová ochrana
...
#### Trojice institutů obecné ochrany v § 4

Paragraf 4 normuje **tři klíčové instituty obecné ochrany**, vzájemně koncepčně propojené, ale procesně rozdílné:

| Institut | Odst. | Procesní nástroj | Povaha aktu |
|---|---|---|---|
| **ÚSES** | 1 | Hodnocení, vymezení v ÚP, zákonem stanovené povinnosti vlastníků a uživatelů | Není správní akt; ÚSES působí systémově prostřednictvím ÚPD |
| **VKP** | 2 | Souhlas se zásahem | Závazné stanovisko / rozhodnutí |
| **Lesní hospodářské plány** | 3–5 | Souhlas ke schválení LHP / předání LHO + hodnocení dopadů na EVL/PO | Závazné stanovisko, navazující na § 45i |
| **Hornická činnost a rekultivace** | 6 | Souhlas k dobývacímu prostoru, hornické činnosti, dobývání nevyhrazených nerostů, likvidaci důlních děl | Závazné stanovisko |

#### ÚSES — povinnost vlastníků a veřejný zájem (odst. 1)

Klíčové je zde **dvojí konstrukční rozhodnutí zákonodárce**:

1. **Ochrana již existujícího ÚSES** je definována jako **povinnost vlastníků a uživatelů**. Jde tedy o zákonné omezení vlastnického práva (čl. 11 odst. 3 Listiny), které nevyžaduje další konstitutivní akt vůči konkrétnímu vlastníkovi. ÚSES, který je vymezen v platné územně plánovací dokumentaci (zásady územního rozvoje kraje, územní plán obce, regulační plán), je tedy závazný pro každého, kdo na pozemcích hospodaří či s nimi nakládá.

2. **Vytváření nového ÚSES** je výslovně označeno za **veřejný zájem**. Tato kvalifikace má dva praktické dopady: (i) zakládá legitimaci pro užití nástrojů veřejného práva (vyvlastnění podle § 60, pozemkové úpravy), (ii) přemosťuje ke kompenzačnímu titulu podle § 58 (finanční náhrada za ztížené hospodaření).

#### VKP a režim souhlasu (odst. 2)

Souhlas podle § 4 odst. 2 se vyžaduje k zásahům, **které by mohly vést** k poškození nebo zničení VKP nebo k ohrožení/oslabení jeho ekologicko-stabilizační funkce. Použití kondicionálu („mohly by") signalizuje, že **postačí potenciální riziko** — orgán ochrany přírody nemusí prokazovat jisté poškození, postačí důvodná obava.

Zákon **demonstrativně vyjmenovává typové zásahy**: umisťování staveb, pozemkové úpravy, změny druhu nebo způsobu využití pozemků, výstavba lesních cest, lesní meliorace, odvodňování pozemků, úpravy vodních toků a nádrží, těžba nerostů. Výčet je otevřený — souhlas může být vyžadován i pro jiné, atypické zásahy.

**Souhlas se vydává:**
- **Rozhodnutím** podle § 90 odst. 1 (správní řízení podle správního řádu), je-li okruh adresátů určitý.
- **Opatřením obecné povahy**, je-li okruh adresátů neurčitý.
- Často také **závazným stanoviskem** v rámci jiného řízení (typicky stavebního) podle § 4 odst. 2 ve spojení s § 149 správního řádu.

V judikatuře byl mnohokrát řešen vztah VKP a stavební činnosti. NSS dovodil, že souhlas podle § 4 odst. 2 je **podkladovým aktem pro stavební povolení** — bez něj nemůže stavební úřad o povolení stavby v lokalitě VKP rozhodnout, ledaže zásah evidentně nemůže VKP ovlivnit.

#### Lesní hospodářské plány a EVL/PO (odst. 3–5)

Odstavce 3–5 upravují vztah ZOPK a lesního zákona (č. 289/1995 Sb.). Souhlas orgánu ochrany přírody ke schválení LHP a předání LHO:

- Nahrazuje **odůvodněné stanovisko** podle § 45i odst. 1 (Natura 2000 — předběžný screening).
- Zahrnuje **plnohodnotné hodnocení vlivu LHP/LHO na EVL/PO**.
- **Není vydáván** k pěstebním a těžebním zásahům podle schváleného LHP ani k nahodilé těžbě.
- **Lhůta:** 60 dnů od doručení žádosti; po marném uplynutí se k souhlasům vydaným opožděně **nepřihlíží**.
- Použití EIA je u tohoto specifického postupu **výslovně vyloučeno**.

Tento režim řeší významný interface mezi lesním hospodařením a ochranou Natury 2000: ekosystémové zásahy v lesích uvnitř EVL či PO se neposuzují jednotlivě, ale **plošně skrze LHP**.

#### Hornická činnost a přírodě blízká obnova (odst. 6)
...
#### Princip obecné druhové ochrany (odst. 1)

Ustanovení § 5 odst. 1 zakotvuje **zásadu obecné druhové ochrany všech rostlin a živočichů**, nikoli pouze ohrožených či vzácných druhů. Zákon tedy **nevyhrazuje obecnou ochranu zvláště chráněným druhům** — ti jsou chráněni navíc přísnějšími režimy podle § 48–50. Obecná ochrana se vztahuje na ničení, poškozování, sběr či odchyt, který vede nebo **by mohl vést** k ohrožení druhu, jeho degeneraci, narušení rozmnožovacích schopností, zániku populace nebo zničení ekosystému.

Tento velmi široký zákaz je v praxi vyvážen tím, že ne každá ztráta jedince znamená automatické porušení § 5: ZOPK necílí na ochranu jednotlivých exemplářů, nýbrž na ochranu **druhů a populací**. Trestněprávní hledisko je proto vázáno na to, zda zásah byl způsobilý ohrozit populaci, nikoliv jednotlivého jedince (s výjimkou zvláště chráněných druhů).

#### Prevence zbytečných škod při hospodaření (odst. 3)

Odstavec 3 ukládá fyzickým a právnickým osobám obecnou prevenční povinnost při zemědělských a lesnických pracích, výstavbě, terénních úpravách, hornické činnosti, vodním hospodářství, dopravě a energetice — postupovat tak, **aby nedocházelo ke zbytečnému úhynu** rostlin a zraňování či úhynu živočichů, ničení jejich biotopů a narušení **migračních tras**, lze-li tomu zabránit **technicky a ekonomicky dostupnými prostředky**.

Klauzule „technicky a ekonomicky dostupnými prostředky" zavádí **kritérium proporcionality**: prevenční opatření musí být realisticky aplikovatelná. Typickými příklady jsou:

- Migrační propustky (např. pro obojživelníky podél silnic, pro ryby v rámci vodních toků).
- Plašiče zvěře na sekačkách a kombajnech.
- Kosení od středu k okrajům louky.
- Ochranná opatření na nadzemních vedeních (viz § 5a odst. 5 — povinnost opatřit nová a rekonstruovaná vedení VN ochrannými prostředky proti usmrcování ptáků elektrickým proudem).

#### Záměrné rozšíření nepůvodních druhů a křížencům (odst. 4–6)

Záměrné vypouštění nepůvodních druhů a kříženců do krajiny je obecně **vázáno na povolení**. Z této povinnosti zákon vyjímá zejména:

- Nepůvodní druhy dřevin pěstované podle schváleného LHP / LHO.
- Vysazování nepůvodních druhů rostlin v zastavěném území obce.
- Vybrané nepůvodní druhy ryb podle nařízení vlády vydaného k zákonu o rybářství.

Povolení **zaniká** zařazením druhu na unijní seznam invazních nepůvodních druhů — od té chvíle se aplikuje přísnější režim § 13d a násl.

#### Záchranné stanice a péče o handicapované živočichy (odst. 11–14)
...
- *NSS* [65 A 5/2024 - 100](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/739756) — 11. 2. 2025
...
#### Transpozice ptačí směrnice (§ 5a)

Ustanovení § 5a transponuje čl. 5–9 **směrnice 2009/147/ES o ochraně volně žijících ptáků** (původně 79/409/EHS). Ochrana se vztahuje na **všechny druhy ptáků volně žijících na evropském území členských států EU**, tedy i na ty, kteří nepatří mezi zvláště chráněné podle § 48. Zákazy z odst. 1 jsou **paušální a obecné**:

- Úmyslné usmrcování či odchyt jakýmkoliv způsobem.
- Úmyslné poškozování či ničení hnízd a vajec, odstraňování hnízd.
- Sběr vajec i prázdných.
- Úmyslné vyrušování v období rozmnožování a odchovu mláďat (kritérium „významnosti z hlediska cílů směrnice").
- Držení druhů, jejichž lov či odchyt je zakázán.

Odstavec 2 navíc zakazuje **prodej, přeprava za účelem prodeje, držení a chov za účelem prodeje** živých i mrtvých ptáků (a snadno rozpoznatelných částí a výrobků z nich).

Odstavec 5 obsahuje **technickou povinnost** každého, kdo buduje nebo rekonstruuje nadzemní vedení VN: opatřit je ochrannými prostředky proti usmrcování ptáků elektrickým proudem. Tato povinnost cílí především na **zákaz tzv. plošin a izolátorů otevřené konstrukce**, jejichž geometrii využívají velcí dravci (káňata, orli, sovy) k usazování s často fatálními následky.

#### Vztah k zvláště chráněným druhům (odst. 6)

Pokud platí přísnější ochrana podle § 48–57 nebo CITES (zákon č. 100/2004 Sb.), uplatní se ona; § 5a a § 5b tvoří „podlahovou" úroveň. Pro běžné druhy (vrabec, kos, sýkora) je § 5a hlavním zdrojem ochrany.

#### Odchylný postup (§ 5b) — derogace z ochrany ptáků

Paragraf 5b transponuje čl. 9 ptačí směrnice. Orgán ochrany přírody může **rozhodnutím** (resp. **opatřením obecné povahy** u neurčitého okruhu osob) stanovit postup odchylný od zákazů § 5a, **neexistuje-li jiné uspokojivé řešení**, je-li to nezbytné v některém z těchto zájmů:

- Veřejné zdraví nebo veřejná bezpečnost.
- Bezpečnost leteckého provozu.
- Prevence závažných škod na úrodě, domácích zvířatech, lesích, rybářství a vodním hospodářství.
- Ochrana volně žijících živočichů a planě rostoucích rostlin.
- Výzkum a výuka, opětovné osídlení, vysazení do původní oblasti, chov v lidské péči pro tyto účely.

Pro **odchyt, držení nebo jiné využívání ptáků v malém množství** lze odchylný postup stanovit i bez závažných důvodů z odst. 1, ale pouze po vyhodnocení stavu místní populace a za **přísně kontrolovaných podmínek** (odst. 2).

Rozhodnutí musí obsahovat:
- Označení druhů a množství ptáků.
- Prostředky, způsob nebo metody povolené pro odchyt/zabíjení.
- Důvod, podmínky, časové a místní okolnosti.
- Způsob kontrol.
...
>
> *(2)–(3) (náležitosti rozhodnutí, zrušení registrace)*
...
- *NSS* [6 A 41/2024 - 260](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/741088) — 31. 3. 2025
...
#### Pojem dřevin a režim ochrany (§ 7)

„Dřevinou" se podle § 3 odst. 1 písm. i) rozumí strom či keř rostoucí mimo lesní pozemky, jednotlivě i ve skupinách. Dřeviny rostoucí na lesní půdě podléhají lesnímu zákonu. ZOPK chrání dřeviny mimo les **před poškozováním a ničením** (§ 7 odst. 1), pokud se na ně nevztahuje přísnější ochrana (památné stromy podle § 46, zvláště chráněné dřeviny podle § 48).

#### Povolení ke kácení (§ 8) — pravidlo a výjimky

**Pravidlem** je nutnost povolení orgánu ochrany přírody — zpravidla obecního úřadu jako orgánu ochrany přírody. Povolení lze vydat **jen ze závažných důvodů** po vyhodnocení funkčního a estetického významu dřeviny. Tento test má dvě složky:

1. **Funkční význam** — ekologická, hygienická, izolační, vodohospodářská role dřeviny.
2. **Estetický význam** — vliv na krajinný ráz, vnímání místa, historickou hodnotu.

**Výjimky (kdy povolení netřeba):**

| Důvod | Procesní režim |
|---|---|
| Pěstební (obnova, výchova porostů) | Oznámení 15 dnů předem |
| Údržba břehových porostů | Oznámení 15 dnů předem |
| Ochranná pásma energetiky, plynárenství, tepla | Oznámení 15 dnů předem |
| Provozuschopnost železniční dráhy | Oznámení 15 dnů předem + závazné stanovisko drážního úřadu |
| Zdravotní důvody (havarijní stav) | Oznámení 15 dnů předem |
| Dřeviny pod stanovenou velikost (vyhláška MŽP č. 189/2013 Sb.) | Bez oznámení |
| Bezprostřední ohrožení života/zdraví nebo škoda značného rozsahu | Oznámení do 15 dnů PO provedení |

Vyhláška **č. 189/2013 Sb.**, o ochraně dřevin a povolování jejich kácení, stanoví minimální obvod kmene 80 cm ve výšce 130 cm; pro souvislé keřové porosty plochu 40 m². Pod tyto velikosti povolení netřeba — výjimka má usnadnit běžnou péči o zahrady. Avšak: i u dřevin pod stanovenou velikost se uplatňuje obecný zákaz poškozování (§ 7 odst. 1) a období, ve kterém se kácení zpravidla provádí (vegetační klid — typicky 1. 11. až 31. 3.).

#### Náhradní výsadba a odvody (§ 9)

Orgán ochrany přírody může v povolení **uložit** přiměřenou náhradní výsadbu na kompenzaci ekologické újmy. Lze také uložit **následnou péči** maximálně na pět let. Náhradní výsadbu na cizích pozemcích lze uložit jen s předchozím souhlasem vlastníka; obce vedou přehled vhodných pozemků.

Není-li uložena náhradní výsadba, je ten, kdo kácí dřeviny **z důvodů výstavby a s povolením**, povinen zaplatit **odvod do rozpočtu obce** (která jej použije na zlepšení životního prostředí). Ten, kdo kácel **protiprávně**, platí odvod do **Státního fondu životního prostředí**. Výši a podmínky odvodů stanoví zvláštní zákon (dosud nepřijatý — ustanovení § 9 odst. 3 fakticky nefunguje pro nedostatek prováděcí úpravy).
...
Ochrana jeskyní je **principiálně absolutní** — zákon zakazuje nejen jejich ničení, ale i jakoukoli úpravu či změnu dochovaného stavu (včetně výplní — sedimentů, krápníkové výzdoby, kostí). Výjimku lze udělit pouze ve dvou taxativně vymezených situacích:

1. **V zájmu ochrany jeskyně samotné** — typicky konzervační zásahy, instalace ochranných mříží proti vandalismu.
2. **Pokud jiný veřejný zájem výrazně převažuje** — vysoký standard „výrazné převahy" (nikoli pouze převahy) odráží unikátní, neobnovitelnou povahu krasových fenoménů.

K **průzkumu nebo výzkumu jeskyně** je třeba povolení; výjimky platí pro orgány ochrany přírody, policii, obranu státu, veterinární a záchranné služby, správu vodních toků. Ochranu jeskyní zákon **rozšiřuje na související povrchové jevy** — krasové závrty, škrapy, ponory a vývěry krasových vod (odst. 4).
...
Paleontologický nález je v § 3 odst. 1 písm. j) definován jako věc, která je významným dokladem nebo pozůstatkem života v geologické minulosti. Ochrana je vázána na **rozpoznání nálezu jeho objevitelem** — povinnost ochrany a oznámení vzniká pouze tehdy, pokud nálezce nález jako paleontologicky významný rozpozná.
...
- *NSS* [1 As 17/2004 - 41](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/243346) — 28. 4. 2005
...
- *NSS* [2 As 77/2008 - 139](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/615089) — 22. 4. 2009
...
#### Pojem krajinného rázu

Krajinný ráz je v § 12 odst. 1 definován skrze čtyři charakteristiky určitého místa či oblasti:

- **Přírodní charakteristika** — geomorfologie, vodní toky, vegetace, fauna.
- **Kulturní charakteristika** — způsob obhospodařování, sídelní struktura.
- **Historická charakteristika** — historické dominanty, památky, dochované krajinné prvky.
- **Estetická hodnota** — komponovanost, harmonie měřítek a vztahů.

Zákon výslovně chrání **harmonické měřítko a vztahy v krajině**. Toto kritérium se v praxi uplatňuje při posuzování staveb v otevřené krajině — především větrných elektráren, vysílačů, fotovoltaických areálů, ale i průmyslových hal v rurální krajině.

#### Souhlas k zásahům do krajinného rázu (odst. 2)

Souhlas se vyžaduje k **umisťování a povolování staveb a jiným činnostem, které by mohly snížit nebo změnit krajinný ráz**. Použití kondicionálu opět signalizuje **dostatečnost potenciálního vlivu**. Metodicky se k posuzování krajinného rázu používají **studie krajinného rázu** zpracovávané podle metodiky AOPK ČR.

#### Případy, kdy se krajinný ráz neposuzuje (odst. 4)

Zákon novelou č. 312/2002 Sb. zavedl výjimky z posuzování krajinného rázu:

1. **V zastavěném území a v zastavitelných plochách**, pro něž je územním plánem nebo regulačním plánem stanoveno plošné a prostorové uspořádání **a podmínky ochrany krajinného rázu dohodnuté s orgánem ochrany přírody**. Klíčové je předjednání podmínek s orgánem ochrany přírody — bez něj výjimka neplatí.
2. **Pro anténní stožáry veřejné komunikační sítě** do 50 m výšky sloužící k plnění podmínek § 22 odst. 2 písm. c) zákona o elektronických komunikacích. Tato výjimka byla zavedena pro urychlení výstavby 5G a podobných sítí.

#### Přírodní park (odst. 3)

**Přírodní park** je institut „**měkké územní ochrany**" — krajinný útvar zřízený obecně závazným právním předpisem kraje (původně okresního úřadu) bez vyhlášení za zvláště chráněné území podle části třetí. V přírodním parku lze stanovit omezení takového využití území, které by znamenalo zničení, poškození nebo rušení stavu území. Přírodní parky chrání **estetické a přírodní hodnoty krajiny** v menším rozsahu než CHKO, zejména historické kulturní krajiny.
...
Přechodně chráněná plocha je **operativním ochranným institutem** s následujícími charakteristikami:

- **Forma:** opatření obecné povahy (OOP).
- **Důvod:** dočasný nebo nepředvídaný výskyt významných druhů, nerostů, paleontologických nálezů, nebo vědecké, studijní či informační důvody.
- **Doba platnosti:** předem stanovená, případně na opakované období (typicky doba hnízdění).
- **Obsah:** omezení takového využití území, které by znamenalo zničení, poškození nebo rušení vývoje předmětu ochrany.
...
### Hlava druhá — Cizí druhy v akvakultuře a invazní nepůvodní druhy (§§ 13a–13l)

Hlava druhá byla do ZOPK vložena zákonem č. 364/2021 Sb. (s účinností převážně od roku 2022) a transponuje:
...
#### Díl 1 — Cizí druhy v akvakultuře (§§ 13a–13c)

Žádost o povolení k **přesunu cizího nebo místně se nevyskytujícího druhu** v akvakultuře podle čl. 6 nařízení 708/2007 se podává u orgánu ochrany přírody. Procedura zahrnuje:

- Vyjádření **společné meziresortní komise pro nepůvodní a invazní nepůvodní druhy** (ZCN a IDN).
- Vyjádření k délce sledování.
- Závazné stanovisko **krajské veterinární správy** a **Ústředního kontrolního a zkušebního ústavu zemědělského** (ÚKZÚZ).
- U **výjimečného přesunu** též posouzení rizik pro životní prostředí (na náklady žadatele).
- **Pokusné vypuštění** — povinný mezistupeň před povolením definitivního přesunu.
- **Pohotovostní plán** podle čl. 17 nařízení.

#### Díl 2 — Ochrana před invazními nepůvodními druhy (§§ 13d–13l)

Tato úprava vytváří **dvouvrstvý ochranný systém** invazních nepůvodních druhů (IDN):

| Vrstva | Pramen | Klíčové ustanovení ZOPK |
|---|---|---|
| **Unijní seznam IDN** | Prováděcí nařízení Komise (EU) 2016/1141 a další | § 13d–§ 13h, § 13j |
| **Regionální spolupráce** | Nařízení Komise nebo nařízení vlády ČR | § 13l |

**Klíčové instituty:**

- **§ 13d — Využívání IDN na unijním seznamu:** Povolení podle čl. 8 odst. 1 nařízení 1143/2014, podmínka schválení pohotovostního plánu, vědecká produkce a léčebné účely (čl. 8 odst. 1), žádost Komisi o oprávnění podle čl. 9.
- **§ 13e — Mimořádná opatření:** Vláda nařízením stanoví, mění a ruší mimořádná opatření (typicky vůči IDN, jehož výskyt byl zjištěn nebo hrozí zavlečení).
- **§ 13f — Sledování:** **Agentura ochrany přírody a krajiny ČR (AOPK)** zajišťuje sledování IDN; orgány státní správy a osoby pověřené podle lesního zákona oznamují výskyt; informace se zveřejňují.
- **§ 13g — Včasné zjištění:** Oznámení Komisi a ostatním státům, rozhodnutí nebo OOP MŽP o opatřeních k odstranění. Při splnění podmínek čl. 18 odst. 1 lze stanovit, že odstraňovací opatření nebudou uplatňována, a místo nich zavést **izolační opatření**.
- **§ 13h — Regulace značně rozšířených IDN:** MŽP vypracuje **zásady regulace**, orgán ochrany přírody stanoví bližší podmínky OOP. **Komerční využívání** značně rozšířeného IDN je možné jen na základě povolení.
- **§ 13i — Náhrada nákladů:** Osoba, která porušila povinnost stanovenou nařízením 1143/2014 nebo ZOPK, je povinna uhradit náklady na prevenci, minimalizaci nebo zmírnění nepříznivých dopadů včetně nákladů na obnovu poškozených ekosystémů.

Mezi typické IDN na unijním seznamu, s nimiž se potýká ČR, patří: **bolševník velkolepý** (Heracleum mantegazzianum), **netýkavka žláznatá** (Impatiens glandulifera), **křídlatka japonská a sachalinská** (Reynoutria spp.), **želva nádherná** (Trachemys scripta), **norek americký** (Neovison vison), **mýval severní** (Procyon lotor), **psík mývalovitý** (Nyctereutes procyonoides), **nutrie říční** (Myocastor coypus).

#### Společná ustanovení (§§ 13j–13l)

- **Registrační povinnost** vlastníka jedince IDN živočicha na unijním seznamu (1 rok od zařazení druhu na seznam).
- **Možnost umístění do zařízení určeného MŽP** s automatickým přechodem vlastnictví.
- **Povinnost uživatele pozemku** provádět opatření v rámci běžné péče; obdobné použití § 68 odst. 4 (subsidiární zajištění opatření orgánem ochrany přírody).
- **Účast veřejnosti** na zásadách regulace a akčním plánu (60 dnů na připomínky).
- **Regionální spolupráce** s členskými státy EU stran druhů na jejich vnitrostátních seznamech.
...
#### Šest kategorií ZCHÚ — typologie a hierarchie

Zákon zavádí **uzavřenou, taxativní typologii šesti kategorií ZCHÚ**, strukturovanou podle dvou kritérií:

| Kategorie | Plocha | Význam | Forma vyhlášení |
|---|---|---|---|
| **Národní park (NP)** | Rozsáhlé území | Národní/mezinárodní | Zákonem |
| **Chráněná krajinná oblast (CHKO)** | Rozsáhlé území | Národní | Nařízením vlády |
| **Národní přírodní rezervace (NPR)** | Menší území | Národní/mezinárodní | Vyhláška MŽP |
| **Přírodní rezervace (PR)** | Menší území | Regionální | Nařízení kraje |
| **Národní přírodní památka (NPP)** | Menší rozloha | Národní/mezinárodní | Vyhláška MŽP |
| **Přírodní památka (PP)** | Menší rozloha | Regionální | Nařízení kraje |

**Klíčové rozdíly:**

- **NP a CHKO** jsou **velkoplošná ZCHÚ** se zónovým členěním a vlastními správami (správy NP, regionální pracoviště AOPK pro CHKO).
- **NPR, PR, NPP, PP** jsou **maloplošná ZCHÚ** zaměřená na konkrétní biotopy či útvary.
- **Rezervace** chrání primárně **ekosystémové celky** s charakteristickými typickými stanovišti.
- **Památky** chrání primárně **jednotlivé útvary** (geologické, geomorfologické, naleziště nerostů či druhů).
- **„Národní"** prefix značí **národní nebo mezinárodní význam**, zatímco bez prefixu jde o regionální význam.
...
- *NSS* [7 Ao 6/2010 - 44](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/620514) — 15. 12. 2010
...
#### Materiální kritéria národního parku (odst. 1)

NP může být vyhlášen pouze na území, které splňuje **kumulativně** tyto znaky:

- **Rozsáhlost** — NP musí být velkoplošným územím (řádově desítky tisíc hektarů).
- **Typický reliéf a geologická stavba** — krajinná osobitost.
- **Převažující výskyt přirozených nebo člověkem málo pozměněných ekosystémů** — jedná se o vyšší standard než u CHKO.
- **Jedinečnost a význam v národním či mezinárodním měřítku** — z hlediska ekologického, vědeckého, vzdělávacího nebo osvětového.

#### Cíle a poslání NP (odst. 2–4)

Zákon novelou č. 123/2017 Sb. **přepracoval cíle a poslání NP** do moderní podoby. Hierarchie cílů:

1. **Veškeré využití NP** musí být **podřízeno** zachování přirozených ekosystémů, dosažení jejich přirozené biologické rozmanitosti a souladu s cíli ochrany.
2. **Dlouhodobým cílem** je:
   - **Zachování nebo postupná obnova přirozených ekosystémů** včetně **nerušeného průběhu přírodních dějů** v jejich přirozené dynamice na převažující ploše NP.
   - **Zachování nebo postupné zlepšování stavu ekosystémů**, jejichž existence je **podmíněna činností člověka**, na zbývajícím území NP (typicky horské louky, kulturní lesy).
3. **Posláním NP** je:
   - Naplňovat dlouhodobé cíle ochrany.
   - Umožnit trvale udržitelný rozvoj, vzdělávání, výchovu, výzkum.
   - Umožnit **přírodě šetrné turistické využití**.
...
| § | Národní park | Rok zřízení | Rozloha (přibližně) | Charakter |
|---|---|---|---|---|
| § 15a | **NP České Švýcarsko** | 2000 | 79 km² | Pískovcové skály |
| § 15b | **Krkonošský NP (KRNAP)** | 1963 | 363 km² | Subalpínské tundry, ledovcové kary |
| § 15c | **NP Podyjí** | 1991 | 63 km² | Říční kaňon, lesnatá xerotermní krajina |
...
> **§ 16**
>
> *(1) Na celém území národních parků je zakázáno [12 zákazů — písm. a)–l)]*
>
> *(2) Na území národních parků mimo zastavěná území obcí a zastavitelné plochy obcí je zakázáno [20 zákazů — písm. a)–t)]*

**Výklad:**

Paragraf 16 je **klíčovým zákazovým paragrafem pro národní parky**. Strukturuje zákazy do dvou skupin:

**Judikatura (z místních zdrojů):**

- *NSS* [5 Ca 170/2008 - 56](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/564115) — 14. 9. 2011
...
#### Odst. 1 — Celoplošné zákazy (12 zákazů)

Tyto zákazy platí **na celém území NP včetně intravilánu obcí**:

- Důlní díla a důlní stavby (kromě likvidace stávajících).
- Nové průmyslové zóny.
- Stanovení průzkumných území.
- Těžba nerostů, rašeliny, slatiny (kromě stavebního kamene a písku pro stavby v NP).
- Odstraňování odpadů s původem **mimo NP**.
- Záměrné rozšiřování nepůvodních druhů rostlin.
- Intenzivní chovy zvěře (obory, farmové chovy, bažantnice).
- Změna stávajícího vodního režimu pozemků.
- Vypouštění živočichů (s výjimkou záchranných programů a vyléčených zvířat ze záchranných stanic).
- **Světelné zdroje směřující nad vodorovnou rovinu** (ochrana před světelným znečištěním — novelizováno).
- Ohňostroje a zábavní pyrotechnika.
- Lety v rozporu s OOP (kromě letů pro bezpečnost státu, IZS apod.).

#### Odst. 2 — Zákazy mimo intravilán (20 zákazů)

Tato přísnější skupina platí pouze **mimo zastavěná území a zastavitelné plochy**:

- Činnosti způsobující podstatné změny biodiverzity, struktury, funkce ekosystémů.
- Povolování staveb (s výjimkami: ochrana přírody, péče o ZPF a lesy, turistika, vodní toky, IZS, obrana, památková ochrana, drobné záměry).
- Odstraňování svrchní vrstvy půdy a terénní úpravy.
- Geologické práce.
- Sběr nerostů, rostlin, odchyt živočichů (kromě obhospodařování, výzkumu, myslivosti, rybářství, obecného užívání lesů).
- Umělá hnojiva, kejda, silážní šťávy, vápnění (mimo zahrady).
- Vysévání rostlin (kromě stanovištně původních dřevin a místních odrůd).
- Biocidy mimo budovy.
- Skladování pohonných hmot a chemických přípravků mimo vyhrazená místa.
- Odstraňování odpadů s původem v NP mimo vyhrazená místa.
- Úpravy přirozených koryt vodních toků (s výjimkou bezprostředního ohrožení).
- **Vjezd motorových vozidel mimo silnice a vyhrazená místa** (s řadou výjimek — IZS, obhospodařování, vlastníci a nájemci).
- Jízda na kole nebo na koni mimo silnice a vyhrazená místa.
- Horolezecké, vodní sporty mimo vyhrazená místa.
- Táboření mimo vyhrazená místa.
- Rozdělávání ohňů mimo vyhrazená místa.
- Pořádání sportovních, turistických a veřejných akcí mimo vyhrazená místa.
- Volný a stánkový prodej mimo budovy.
...
- **§ 16a — NP České Švýcarsko:** zákaz zasahování do skalních útvarů, zákaz nocování v přírodě mimo vyhrazená místa, zákaz volného pobíhání domácích zvířat, souhlas k novým vyhlídkám, zpřístupňování skal, informačním zařízením, změně využití pozemků.
...
**Klidová území** zavedla novela č. 123/2017 Sb. jako náhradu za dřívější institut tzv. „I. zóny" v některých NP. Jejich charakter:

- **Účel:** umožnění nerušeného vývoje citlivých ekosystémů.
- **Forma vyhlášení:** opatření obecné povahy MŽP.
- **Režim:** zákaz pohybu mimo vyhrazené cesty/trasy.

**Výjimky** ze zákazu pohybu:
- Vlastníci a nájemci pozemků při vstupu na své pozemky.
- IZS, obecní policie, AČR, Celní správa, Vězeňská služba.
- Pracovníci dalších orgánů veřejné moci, památkové péče, veterinární služby.
- Pracovníci správců vodních toků, provozovatelů sítí.

Klidová území jsou **funkčně odlišena od zón ochrany přírody NP** (§ 18). Zatímco zóny vymezují **režim hospodaření a péče**, klidová území vymezují **omezení návštěvnického pohybu** — mohou se tedy překrývat se zónami libovolně. Hranice klidového území a podmínky pohybu se vyznačí v terénu způsobem stanoveným vyhláškou MŽP.
...
#### Čtyřzónová struktura (§ 18)

Novela č. 123/2017 Sb. zavedla **jednotnou čtyřzónovou strukturu pro všechny NP**, která nahradila předchozí trojzónovou strukturu odlišnou v každém NP:

| Zóna | Charakteristika ekosystémů | Cíl |
|---|---|---|
| **Přírodní** | Přirozené ekosystémy | Zachování + nerušený průběh přírodních procesů |
| **Přírodě blízká** | Člověkem částečně pozměněné ekosystémy | Dosažení stavu odpovídajícího přirozeným |
| **Soustředěné péče o přírodu** | Člověkem významně pozměněné ekosystémy | Zachování biodiverzity podmíněné činností člověka NEBO obnova přírodě blízkých ekosystémů |
| **Kulturní krajina** | Zastavěná území, zastavitelné plochy, ekosystémy určené k trvalému využívání | Udržitelný rozvoj |

**Procesní pravidla:**

- Vymezení a změny zón **stanoví MŽP vyhláškou** (po dohodě s radou NP — § 20 odst. 3).
- **Mlčící klauzule:** Projednávání změn zón lze poprvé zahájit **nejdříve 15 let po nabytí účinnosti první vyhlášky** o zónách (cílí na stabilitu vymezení).
- **Flexibilita:** Do zón lze zařadit i území nesplňující charakteristiku — pokud je to nezbytné z důvodů jednotného způsobu péče (odst. 2) nebo z důvodů celistvosti plochy segmentu (odst. 3, max. 5 ha souvislé plochy, max. 1/10 plochy segmentu).

#### Režim zón (§ 18a)

V každé zóně jsou povoleny **pouze zásahy, které nejsou v rozporu s cílem ochrany dané zóny**. Konkrétní výjimky se hierarchizují od nejpřísnější zóny po nejvolnější:

- **Zóna přírodní:** Pouze zásahy v souladu s cílem; výjimečně 10 typů opatření (boj s invazními druhy, hašení požárů, odstraňování staveb, regulace spárkaté zvěře, bezpečnost na trasách, údržba cestní sítě, ochrana ZCHD, monitoring/výzkum nezasahující do prostředí, údržba turistických tras, jednorázová obnova vodního režimu).
- **Zóna přírodě blízká:** Vše ze zóny přírodní + opatření k podpoře ekologické stability/biodiverzity + revitalizace + ochrana lesa.
- **Zóna soustředěné péče o přírodu:** Vše z předchozích zón + opatření na obnovu/zachování ekologické stability a biodiverzity + opatření na obnovu/zachování biotopů a populací vzácných a ohrožených druhů.
- **Zóna kulturní krajiny:** Pouze opatření nebo zásahy, které neohrožují předmět ochrany NP a naplňování cílů.
...
**Rada NP** je iniciativním a konzultačním orgánem správy NP pro projednání všech důležitých dokumentů ochrany a řízení NP. Členy jsou:

- Delegovaní zástupci všech obcí a krajů na území NP a OP.
- V horských oblastech zástupci **Horské služby**.
- Další členové jmenovaní orgánem ochrany přírody — z významných právnických a fyzických osob (ochrana přírody, lesnictví, zemědělství, vodní hospodářství, obchod a cestovní ruch, vědecká pracoviště, orgány státní správy).

**Dohodovací režim** s radou:
- Návrh zón NP, návrh klidových území, cesty a trasy v klidových územích, vyhrazená místa — orgán ochrany přírody **povinen dohodnout s radou**.
- Návrh **zásad péče o NP** — dohoda postupem podle § 38a.
- **Mediace** při nedohodě: rada předloží rozpor MŽP, které může návrh upravit a o změně radu informuje.
...
**§ 22 — Lesy v NP nejsou lesy hospodářskými.** S lesy, pozemky určenými k plnění funkcí lesa a souvisejícím majetkem ve vlastnictví státu hospodaří **správa NP** podle své územní působnosti.

**§ 22a — Nakládání s lesy:**
- Vlastníci a nájemci lesů **hospodaří tak, aby byly zachovány nebo podporovány přirozené ekologické funkce a biodiverzita**.
- V zóně přírodní a přírodě blízké se **nepoužijí** některá ustanovení lesního zákona (povinnost obnovovat a vychovávat porosty, lhůty k zalesnění holin, povinné meliorace, hrazení bystřin, povinné provádění nahodilé těžby, opatření proti škůdcům — s výjimkou preventivních opatření proti požárům).
- **Zóna přírodní** se **nezahrnuje do výpočtu závazných ustanovení LHP** — neumisťují se v ní těžby ani výchovná a pěstební opatření.
- V **zóně přírodě blízké** se závazné ustanovení LHP **maximální celková výše těžeb** stanoví jako součet jednotlivých těžeb v porostech (nikoli paušálně).

**§ 22b — Zemědělské pozemky:**
- Vlastníci a nájemci hospodaří tak, aby byly zachovány nebo podporovány ekologické funkce a biodiverzita.
- V zónách přírodní a přírodě blízké se přednostně uplatňují postupy k naplnění cílů ochrany.
- Na tyto pozemky se **nevztahuje** zákon o ochraně zemědělského půdního fondu.
...
### Hlava třetí — Chráněné krajinné oblasti (§§ 25–27)
...
- *NSS* [10 As 16/2025 - 52](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/742364) — 11. 6. 2025
...
- *NSS* [7 As 372/2018 - 40](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/650717) — 30. 5. 2019
...
#### Materiální kritéria CHKO

CHKO se odlišuje od NP nižší přísností materiálních kritérií:

- **Harmonicky utvářená krajina** (na rozdíl od „přirozených/málo pozměněných ekosystémů" NP).
- **Významný podíl přirozených ekosystémů lesních a trvalých travních porostů** — důraz na **lesní a luční ekosystémy**.
- **Hojné zastoupení dřevin**.
- Popřípadě **dochované památky historického osídlení** — kulturně-historický rozměr.

CHKO je tedy primárně **kulturní krajinou s vysokou přírodní hodnotou**, kde se má **udržovat harmonický stav krajiny tradičním obhospodařováním**. Rekreační využití je přípustné, pokud nepoškozuje přírodní hodnoty.
...
> **§ 26**
>
> *(1) Na celém území chráněných krajinných oblastí je zakázáno [9 zákazů].*
>
> *(2) Na území první zóny CHKO je dále zakázáno [5 dalších zákazů].*
>
> *(3) Na území první a druhé zóny CHKO je dále zakázáno [3 další zákazy].*

**Výklad:**

CHKO mají **třístupňový systém zákazů** podle zón:

**Celoplošné zákazy (odst. 1) — 9 zákazů:**
- Odpady mimo vyhrazená místa.
- Táboření a ohně mimo intravilán a vyhrazená místa.
- Vjezd motorových vozidel mimo silnice, místní komunikace a vyhrazená místa (s výjimkami).
- Záměrné rozšiřování nepůvodních a cizích druhů.
- Otrávené návnady při myslivosti.
- Nové dálnice, sídelní útvary, plavební kanály.
- Automobilové a motocyklové soutěže.
- Chemický posyp cest.
- Měnit dochované přírodní prostředí v rozporu s bližšími podmínkami.

**Zákazy v 1. zóně CHKO (odst. 2) — dalších 5:**
- Nové stavby.
- Měnit využití území.
- Měnit skladbu a plochy kultur (nevyplývá-li z plánu péče).
- Hnojit, kejda, silážní šťávy, tekuté odpady.
- Těžit nerosty a humolity.

**Zákazy v 1. a 2. zóně CHKO (odst. 3) — dalších 3:**
- Hospodařit intenzivními technologiemi mimo intravilán.
- Intenzivní chovy zvěře (obory, farmové, bažantnice).
- Soutěže na kolech mimo silnice/místní komunikace/vyhrazená místa.
...
- **1. zóna** — jádrová území s nejvyšší přírodní hodnotou, obvykle ZCHÚ uvnitř CHKO.
...
### Hlava čtvrtá — Národní přírodní rezervace a přírodní rezervace (§§ 28–34)
...
#### Materiální kritéria NPR

NPR se odlišuje od NP plochou (**menší** území) a od PR významem (**národní/mezinárodní**, nikoli pouze regionální):

- **Menší území.**
- **Mimořádné přírodní hodnoty.**
- **Přirozený reliéf s typickou geologickou stavbou.**
- **Ekosystémy významné a jedinečné v národním či mezinárodním měřítku.**

**Forma vyhlášení:** **vyhláška MŽP**. Bližší ochranné podmínky stanoví MŽP přímo ve vyhlášce.
...
- Intenzivní technologie hospodaření, chemizace, změna vodního režimu, terénní úpravy.
- Povolování nebo provádění staveb, změna druhu nebo způsobu využití pozemků, změna užívání staveb, vymezení zastavitelných ploch.
- Těžba nerostů a humolitů.
- **Vstup a vjezd mimo cesty vyznačené orgánem ochrany přírody** (s výjimkami: vlastníci, nájemci, lesní a zemědělské hospodaření, IZS, obrana státu, hraniční služba, zdravotní a veterinární služby).
- Záměrné rozšiřování nepůvodních a cizích druhů.
- Horolezectví, paragliding, závěsné kluzáky, jízda na kolech mimo silnice/komunikace/vyhrazená místa.
- Intenzivní chovy zvěře, otrávené návnady.
- Vjezd motorových vozidel (s úzkými výjimkami).
- Sběr a odchyt rostlin a živočichů (kromě případů podle § 30).
- Táboření a rozdělávání ohňů mimo vyhrazená místa.
- Měnit dochované přírodní prostředí v rozporu s bližšími podmínkami.
...
**§ 31:** Lesy v NPR **nelze zařazovat do kategorie lesů hospodářských**. Ustanovení o zásazích proti škůdcům a o případech mimořádných okolností a nepředvídaných škod (lesního zákona) lze použít **jen se souhlasem a v rozsahu stanoveném orgánem ochrany přírody**.
...
#### Materiální kritéria PR — regionální obdoba NPR

PR má **kvalitativně nižší** materiální parametry než NPR:

- **Menší území** (jako NPR).
- **Soustředěné přírodní hodnoty** (na rozdíl od „mimořádných" u NPR).
- **Ekosystémy typické a významné pro příslušnou geografickou oblast** (regionální význam místo národního/mezinárodního).

**Forma vyhlášení:** **nařízení kraje** (po novele č. 218/2004 Sb.). PR je tedy ZCHÚ kraje, zatímco NPR je ZCHÚ MŽP (s celostátní působností).
...
- Intenzivní technologie hospodaření poškozující půdní povrch nebo ekosystémy.
- Používání biocidů.
- Povolování nebo provádění staveb, změna druhu/způsobu využití pozemků.
- Záměrné rozšiřování nepůvodních a cizích druhů.
- Sběr a odchyt rostlin a živočichů (**kromě výkonu myslivosti a rybářství či sběru lesních plodů** — důležitá rozdílnost od NPR).
- Měnit dochované přírodní prostředí v rozporu s bližšími podmínkami.
...
### Hlava pátá — Národní přírodní památky a přírodní památky (§§ 35–36)
...
NPP chrání **přírodní útvar menší rozlohy**, který může mít původ:

- **Přírodní** — geologický (skalní útvar), geomorfologický, naleziště nerostů či vzácných/ohrožených druhů ve fragmentech ekosystémů.
- **Antropogenní** („formoval svou činností člověk") — pohřebiště fosilií odhalená lomovou činností, opuštěné lomy s významnými geologickými profily, staré sady s reliktními druhy.

**Význam:** národní nebo mezinárodní (na rozdíl od PP — regionální).

**Forma vyhlášení:** vyhláška MŽP.
...
- Stejná materiální charakteristika přírodního útvaru (geologický, geomorfologický, naleziště).
...
### Hlava šestá — Ochranná pásma, plány péče, smluvní ochrana, vyhlašování (§§ 37–45)

#### § 37 — Ochranná pásma ZCHÚ
...
#### Funkce a typy ochranných pásem

Ochranné pásmo (OP) slouží k **ochraně ZCHÚ před rušivými vlivy z okolí** (např. světelné znečištění, hluk, znečištění vod z polí). OP **lze vyhlásit** pro každé ZCHÚ **kromě CHKO** (CHKO svou velikostí samo plní funkci nárazníkové zóny).

**Tři režimy OP:**

1. **Vyhlášené OP** — vyhlašuje se stejným způsobem jako ZCHÚ. V něm lze vymezit činnosti vázané na předchozí souhlas.
2. **Zákonné OP (default)** — pokud OP NPR, NPP, PR, PP nebylo vyhlášeno, **automaticky platí pásmo do vzdálenosti 50 m od hranic ZCHÚ**. Tento konstrukt vznikl novelou č. 218/2004 Sb. a zaručuje minimální ochranu i u maloplošných ZCHÚ bez vyhlášeného OP.
3. **Žádné OP** — orgán ochrany přírody může při vyhlášení ZCHÚ stanovit, že se vyhlašuje **bez ochranného pásma**.

#### Činnosti vázané na souhlas v OP (odst. 2)

V OP **kteréhokoli ZCHÚ** je nutný souhlas k:
- Povolování nebo provádění staveb.
- Změně způsobu využití pozemků.
- Terénním úpravám.
- Změnám vodního režimu pozemků nebo vodních toků.
- Nakládání s vodami.
- Použití chemických prostředků.
- Změnám druhu pozemku.

#### Speciální režim OP NP (odst. 3)

V OP **národního parku** se dále souhlas vyžaduje k:
- Táboření mimo místa vyhrazená OOP a mimo intravilán.
- Zemědělskému hospodaření při riziku překročení ekologicky únosného režimu přísunu živin (K, N, P).
- Odstraňování odpadů.
...
- *NSS* [8 A 112/2023 - 49](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/720173) — 24. 1. 2024
...
- *NSS* [10 A 20/2025 - 185](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/744694) — 24. 7. 2025
...
#### Plán péče (§ 38) — pro NPR, PR, NPP, PP a CHKO

**Klíčové charakteristiky plánu péče:**

| Atribut | Specifikace |
|---|---|
| **Pro koho** | NPR, PR, NPP, PP a CHKO (NE pro NP — ten má vlastní zásady péče podle § 38a) |
| **Povaha** | Odborný a koncepční dokument |
| **Funkce** | Navrhuje opatření, slouží jako podklad pro plánovací dokumenty a rozhodování |
| **Závaznost** | **Není závazný pro fyzické ani právnické osoby** (závazný je pro orgány ochrany přírody jako podklad rozhodování) |
| **Zpracovatel** | Orgán ochrany přírody příslušný k vyhlášení ZCHÚ; pro CHKO **MŽP** |
| **Doba platnosti** | **Zpravidla 10 až 15 let** |
| **Účast veřejnosti** | Oznámení o možnosti seznámit se s návrhem na portálu veřejné správy a na úřední desce obcí; projednání s dotčenými obcemi a kraji |
| **Schválení** | Protokol orgánu ochrany přírody o vypořádání připomínek (zároveň schvaluje plán) |
| **Uložení** | Ústřední seznam ochrany přírody (§ 42) + předání obcím a krajům |

#### Zásady péče (§ 38a) — pro NP

NP mají vlastní, koncepčně významnější dokument — **zásady péče**:

| Atribut | Specifikace |
|---|---|
| **Pro koho** | NP a jejich ochranná pásma |
| **Povaha** | Koncepční odborné dokumenty |
| **Funkce** | Stanoví **rámcové zásady péče** + postup a způsob naplňování dlouhodobých cílů ochrany a poslání NP |
| **Zpracovatel** | Orgán ochrany přírody (správa NP) |
| **Doba platnosti** | **Zpravidla 15 až 20 let** |
| **Účast veřejnosti** | Oznámení na portálu veřejné správy a na úřední desce obcí; **každý** může podat připomínky do 60 dnů |
| **Dohoda s radou NP** | Povinná podle § 20 odst. 3 |
...
Smluvní ochrana je **moderní alternativou klasické vyhlašovací procedury**, zavedená novelou č. 218/2004 Sb. (v souvislosti s Naturou 2000). Konstrukce:

- **Primárně pro EVL** — pro evropsky významné lokality je smluvní ochrana výslovně preferovaná před vyhlášením NPR/NPP/PR/PP. Důvodem je princip součinnosti s vlastníky pozemků zakotvený v § 1.
- **Sekundárně i pro jiná území nebo stromy** — kdy jsou zastoupeny významné či jedinečné ekosystémy nebo stanoviště vzácných či ohrožených druhů, pokud již nejsou zvláště chráněny.
- **Forma:** **písemná smlouva** mezi vlastníkem dotčeného pozemku a příslušným orgánem ochrany přírody.

**Obligatorní obsah smlouvy:**
- Vymezení ochranných podmínek.
- Způsob péče o chráněné území/strom.

**Právní povaha:** Smluvní ochrana je vázána k pozemku formou **věcného břemene** zapisovaného do katastru nemovitostí. Vyznačuje se tím, že je smluvní v okamžiku sjednání, ale věcně-právní v okamžiku zápisu — váže i nové vlastníky pozemku.

**Zrušení smluvní ochrany** (§ 45 odst. 2): Písemnou dohodou mezi vlastníkem a orgánem; při nesouhlasu vlastníka rozhoduje o zrušení orgán, který smlouvu uzavřel.

**Judikatura (z místních zdrojů):**

- *NSS* [4 As 63/2025 - 40](https://vyhledavac.nssoud.cz/DokumentOriginal/Text/742956) — 27. 6. 2025
...
#### Procesní kroky vyhlašování (odst. 1–4)

Vyhlašovací řízení má následující strukturu:

1. **Záměr** — orgán ochrany přírody zpracuje záměr s vyhodnocením stavu prostředí a návrhem způsobu a rozsahu ochrany včetně bližších ochranných podmínek.
2. **Distribuce záměru:**
   - Pro NPR, PR, NPP, PP nebo OP: zasílá orgán ochrany přírody příslušný k vyhlášení **obcím a krajům**, jejichž území se týká; vlastníkům zapsaným v katastru zasílá **písemné oznámení**; zveřejní na portálu veřejné správy.
   - Pro NP, CHKO nebo OP NP: zasílá **MŽP** obcím a krajům; vlastníkům doručí **veřejnou vyhláškou**; zveřejní na portálu veřejné správy. Dotčené obce zveřejní oznámení do 5 dnů na svých úředních deskách.
3. **Námitky:**
   - **Obce a kraje:** **90 dnů** od obdržení záměru.
   - **Vlastníci:** **90 dnů** od doručení písemného oznámení nebo od zveřejnění veřejnou vyhláškou.
   - K opožděným námitkám se nepřihlíží.
   - Vlastník může uplatnit námitky **jen proti takovému způsobu nebo rozsahu ochrany, jímž by byl dotčen ve výkonu svých práv nebo povinností**.
4. **Rozhodování o námitkách:** orgán ochrany přírody do **60 dnů** od uplynutí lhůty pro námitky; uvede záměr do souladu s námitkami, kterým bylo vyhověno.

#### Stavební stop (odst. 5) — klíčový institut

Od doby **zveřejnění záměru** až do **vyhlášení ZCHÚ**, nejdéle však **po dobu dvou let**, se **každý** musí zdržet všech zásahů, které by negativně měnily či poškozovaly dochovaný stav přírody.

Tento institut je **preventivní ochranou** budoucího ZCHÚ — bez něj by hrozilo, že vlastníci v období projednávání záměru rychle zlikvidují cenné prvky (vykácení, výstavba, melioration). Klíčové parametry:

- **Adresát:** **každý** (nikoli pouze vlastníci).
- **Začátek:** zveřejnění záměru.
- **Konec:** vyhlášení ZCHÚ NEBO uplynutí 2 let (cokoli nastane dříve).
- **Obsah:** zákaz zásahů negativně měnících či poškozujících dochovaný stav.

#### Rozsah omezení (odst. 6)

Rozsah dotčených nemovitostí, omezení vlastníků, vymezení ZCHÚ/OP/zón, bližší ochranné podmínky a výčet činností vázaných na souhlas v OP **nesmí přesáhnout** rozsah omezení vyplývajících ze záměru, upraveného podle rozhodnutí o námitkách.

Toto je **klíčová garance vlastníků**: konečný akt (zákon, nařízení vlády, vyhláška MŽP, nařízení kraje) nesmí být přísnější než schválený záměr po vypořádání námitek.
...
**Ústřední seznam ochrany přírody** vede AOPK ČR jako informační systém veřejné správy přístupný **dálkovým způsobem**. V něm se evidují:

- ZCHÚ (NP, CHKO, NPR, PR, NPP, PP).
- **Evropsky významné lokality**.
- **Ptačí oblasti**.
- Chráněná území podle § 39 (smluvní ochrana).
...
Paragraf 43 stanoví **tři alternativní důvody** pro povolení výjimky ze zákazů ve ZCHÚ:

1. **Převažující jiný veřejný zájem** — typicky obrana státu, ochrana zdraví, výstavba klíčové infrastruktury, prevence živelných pohrom. Vyžaduje výslovné prokázání převahy.
2. **Zájem ochrany přírody** — typicky vědecký výzkum, asanační zásahy proti invazním druhům, záchranné programy, regulace přemnožené zvěře.
3. **Činnost významně neovlivní zachování stavu předmětu ochrany** — bagatelní zásahy bez praktického dopadu (např. drobné stavební úpravy historické chalupy).

**Forma výjimky:**
- **Rozhodnutí** — pro určitý okruh adresátů.
- **Opatření obecné povahy** — pro blíže neurčený okruh osob (odst. 2).

**Vyhrazení míst a tras** (odst. 3) podle § 16a odst. 1 písm. c), § 16 odst. 2, § 17 odst. 2, § 29 a § 37 odst. 3 písm. a) a d) — opatření obecné povahy.
...
- **Odst. 1:** Bez tohoto souhlasu nelze povolit stavbu, její užívání, kolaudaci nebo odstranění; vydat povolení k nakládání s vodami a k vodním dílům; povolení k některým činnostem či souhlas podle vodního zákona — **na území NP nebo CHKO**.
- **Odst. 2:** Pro stavby, terénní úpravy, výkopové práce, práce hornickým způsobem, změny vodního režimu — **ve všech ZCHÚ**, pokud nejsou zakázány.
...
ZCHÚ a OP **lze zrušit pouze**:
- **Stejným způsobem**, jakým bylo provedeno vyhlášení (zákonem, nařízením vlády, vyhláškou MŽP, nařízením kraje).
...
Část první až polovina části třetí ZOPK tvoří **systémový základ české ochrany přírody a krajiny**, opřený o tři pilíře: (1) **obecnou ochranu** všech přírodních hodnot bez nutnosti zvláštního vyhlášení (ÚSES, VKP, dřeviny, jeskyně, paleontologické nálezy, krajinný ráz, obecná druhová ochrana, ochrana před invazními druhy), (2) **zvláštní územní ochranu** formou šesti kategorií ZCHÚ (NP, CHKO, NPR, PR, NPP, PP) s odstupňovaným režimem zákazů a souhlasů, (3) **procesní rámec** pro vyhlašování a rušení ZCHÚ s ochranou vlastnických práv (záměr, námitky, stavební stop). Klíčovými prvky transpozice unijního práva jsou pojmy soustavy Natura 2000 (EVL, ptačí oblast, příznivý stav), režim invazních nepůvodních druhů podle nařízení 1143/2014 a režim cizích druhů v akvakultuře podle nařízení 708/2007. Pro výklad jednotlivých ustanovení je nezbytné mít na zřeteli základní princip § 1 — participaci krajů, obcí, vlastníků a správců pozemků a povinnost zohlednit hospodářské, sociální a kulturní potřeby.
